...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <div class="main-sidebar d-flex flex-column flex-shrink-0 bg-dark text-white" style="width: 4.5rem;">

        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            <li class="nav-item">
                <a href="#" class="nav-link active py-3 border-bottom text-white" aria-current="page" title="Home" data-bs-toggle="tooltip" data-bs-placement="right">
            ...
            <li>
                <a href="#" class="nav-link py-3 border-bottom text-white" title="Dashboard" data-bs-toggle="tooltip" data-bs-placement="right">
...
<div class="b-example-divider" style="background-color: white; opacity:0;"></div>
